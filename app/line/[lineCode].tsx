...
export default function LineDetailsScreen() {
  const { lineCode, lineId, lineName } = useLocalSearchParams<{
    lineCode: string;
    lineId: string;
    lineName: string;
  }>();
      ...
      >
        <View style={styles.stopLeft}>
            ...
            <View
              style={[
                styles.timelineLine,
                {
                  ...
                  display: index === (stops?.length ?? 0) - 1 ? "none" : "flex",
                },
              ]}
            />
          </View>
          ...
          <View style={styles.stopInfo}>
            ...
            {item.StopStreet ? (
              <Text
                style={[styles.stopSubtitle, { color: colors.textSecondary }]}
              >
                {item.StopStreet}
              </Text>
            ) : null}
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      {routes && routes.length > 0 && (
        <View
          style={[styles.routeSelector, { borderBottomColor: colors.border }]}
        >
          <TouchableOpacity
